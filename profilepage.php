<html>
    ...
    <?php
            ...
            <script type="text/javascript">
            	...
            	alert("Please fill details before generating profile page.");
    		...
    		<div class="col-sm-12">
    			 ...
    			 <table border=0  class="table table-hover style3">
    				...
    				<tr>
    						...
    						<td rowspan="5" align=center><img src="<?php echo $_SESSION['image'];  ?>" height=160px width=160px alt="no image found"  class="img img-circle" ></td>
